...
- n: "→<br>`address`"
  ...
  d: "The pai address given as parameter"
...
- n: "→<br>`account`"
  t: "string"
  p: "Optional<br>(0 or 1)"
  d: "*Deprecated: will be removed in a later version of Pai Core*<br><br>The account this address belong to.  May be an empty string for the default account.  Only returned if the address belongs to the wallet"

- n: "→<br>`hdkeypath`"
  t: "string"
  p: "Optional<br>(0 or 1)"
  d: "*Added in Pai Core 0.13.0*<br><br>The HD keypath if the key is HD and available"  
  
- n: "→<br>`hdmasterkeyid`"
  t: "string (hash160)"
  p: "Optional<br>(0 or 1)"
  d: "*Added in Pai Core 0.13.0*<br><br>The Hash160 of the HD master public key"  
